...
限時 buff（加速/強化砲彈）與星星等級在死亡重生後清除；
HUD 中段顯示進行中的 buff（★ 等級、PW/SP/FT 剩餘秒數）。
...
- 寶物系統七種道具（+1 命 / 加速 / 護盾 / 強化砲彈破鋼牆 / 鏟子加固基地 / 星星火力升級 / 炸彈全滅），
  加權機率掉落、限時存在、HUD buff 狀態列、撿取音效與浮字回饋
